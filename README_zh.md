...
- Claude Web API：原生 Messages、OpenAI 兼容 Chat、文件暂存和显式会话重置。
- Claude Code API：原生 Messages、Token 统计和 OpenAI 兼容 Chat。
- Shared service and admin API：认证、配置、Cookie、错误格式和 `--no-fs`。
